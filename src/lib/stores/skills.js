export default [
	...
	{ name: "Markdown", icon: "simple-icons:markdown", color: "#000000" },
	// { name: "EJS", icon: "file-icons:ejs", color:"#88CE02" },
	// { name: "Socket.io", icon: "simple-icons:socketdotio", color:"#010101" },
	{ name: "Prisma", icon: "simple-icons:prisma", color: "#2D3748" },
	{ name: "Mongoose", icon: "arcticons:letter-lowercase-m", color: "#8F0000" },
	...
	// { name: "esbuild", icon: "simple-icons:esbuild", color:"#FFCF00" },
	{ name: "Thunder Client", icon: "mdi:thunder-circle", color: "#FF6B6B" },
